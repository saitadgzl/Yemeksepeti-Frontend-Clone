...
{
    public class Yemekler_UyeController : Controller
    {
        ...
        // GET: Yemekler_Uye/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Yemekler_Uye/Create
